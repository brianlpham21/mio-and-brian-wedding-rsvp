...
export default function AttendingConfirmation({
  ...
  return (
    <motion.div
      layout
      className="w-full max-w-md mx-auto bg-white rounded-lg shadow-sm px-6 py-8 text-gray-800"
    >
      <GuestsDisplay
        attending={attending}
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setContactInfo((prev) => ({ ...prev, addressLine: e.target.value }))
                }
              />
