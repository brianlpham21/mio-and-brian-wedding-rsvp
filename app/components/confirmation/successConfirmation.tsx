...
export default function SuccessConfirmation({
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center bg-white rounded-lg shadow-md p-8 mt-8 max-w-md mx-auto">
      ...
      <button
        onClick={startOver}
        className="px-6 py-3 rounded-lg font-medium text-black/80 hover:bg-black transition focus:outline-none focus:ring-2 focus:ring-pink focus:ring-offset-2 cursor-pointer bg-coral"
      >
        {t('back-to-start')}
      </button>
    </div>
